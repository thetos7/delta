...
class Energies():
    ...
    def _conv_date(d):
        ...
        return du.parser.parse(
            f"15-{Energies.mois[ma[0].lower()]}-{ma[1]}")  # parfois le mois a une majuscule d'où lower()
    ...
    def __init__(self, application=None):
        ...
        electricite = pd.read_csv('data/prix_reglemente_electricite.csv', sep=';', decimal=',',
                                  parse_dates=['DATE_DEBUT'])
