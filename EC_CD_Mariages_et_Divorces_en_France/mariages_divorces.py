...
class Mariage():
    ...
    def __init__(self, application = None):
        ...
        self.table = pd.read_csv('EC_CD_Mariages_et_Divorces_en_France/data/mariage_pour_tous.csv').drop(columns=['Unnamed: 0'])
        self.histo_1946 = pd.read_csv('EC_CD_Mariages_et_Divorces_en_France/data/mariage_depuis_1946.csv').drop(columns=['Unnamed: 0'])
        ...
        self.map_f = pd.read_csv('EC_CD_Mariages_et_Divorces_en_France/data/mariage_par_departement.csv').drop(columns=['Unnamed: 0'])
