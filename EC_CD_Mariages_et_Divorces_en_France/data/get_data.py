...
# Read data    
mar_14 = pd.read_csv("data/data_mariages_2014.csv", sep=',', low_memory=False)
mar_15 = pd.read_csv("data/data_mariages_2015.csv", sep=',', low_memory=False)
mar_16 = pd.read_csv("data/data_mariages_2016.csv", sep=',', low_memory=False)
mar_17 = pd.read_csv("data/data_mariages_2017.csv", sep=',', low_memory=False)
mar_18 = pd.read_csv("data/data_mariages_2018.csv", sep=',', low_memory=False)
mar_19 = pd.read_csv("data/data_mariages_2019.csv", sep=',', low_memory=False)
mar_20 = pd.read_csv("data/data_mariages_2020.csv", sep=',', low_memory=False)

mar = pd.read_excel('data/mariages par mois.xls', skiprows = {0,1, 2, 3, 5, 6},
...
pacs = pd.read_excel('data/ensemble des pacs.xlsx', skiprows = {0,1, 2, 4},
...
deps = pd.read_excel('data/departements-francais.xls',
...
df.to_csv('data/mariage_pour_tous.csv')
...
map_f.to_csv('data/mariage_par_departement.csv')
...
df.to_csv('data/mariage_depuis_1946.csv')