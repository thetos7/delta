...
from .get_data import get_transport_pollution_eu, get_pollution_per_vehicules_in_france
...
class Pollution():
    ...
    def __init__(self, application=None):
        self.df = get_pollution_per_vehicules_in_france()
    ...
    def update_graph_poll_eu(self, name="NMVOC", year=1990):
        ...
        countries = json.load(
            open('SG_AH_emission_de_CO2_des_transports/data/europe_geoson.json'))
