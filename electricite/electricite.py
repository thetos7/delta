...
class Eletricite():
    def __init__(self, application = None):
        df_full_selected = pd.read_pickle("electricite/data/preprocessed_maingraphdata.pkl")
        df_by_year = df_full_selected.groupby(by=df_full_selected.index.year).sum()
        df_animated = pd.read_pickle("electricite/data/preprocessed_barplotdata.pkl")
        df_prix = pd.read_pickle('electricite/data/preprocessed_pricedata.pkl')
